    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.action_bola_cheia:
                ...
                final CharSequence[] items = {"Gols","Assistências","Roubadas de bola","Sem sofrer gols","Finalizações defendidas","Defesas Difíceis","Defesas de pênaltis"};
                builder.items(items);
                    ...
                    public boolean onSelection( MaterialDialog dialog, View view, int which, CharSequence text) {
                        ...
                        switch(which)
                        {
                            ...
                            case 1:
                                ...
                                roomTexto.setText("Assistências");
                                break;
                            case 2:
                            ...
                            case 5:
                                ...
                                roomTexto.setText("D. Difíceis");
                                break;

                            case 6:
                                //SettingManager.setLastKeyword(MainActivity.this,"variacao_num");
                                getFiltroMercado("scout/DP",1);
                                roomTexto.setText("D. de Pênaltis");
                                break;
                        }
                        return true;
                    }
