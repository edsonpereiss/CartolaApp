...
public class MercadoViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bindToPost(Atletas atletas, View.OnClickListener jogadorClickListener) {
        ...
        roomJogosNum.setText(String.valueOf(atletas.getJogosNum()));
        roomMediaNum.setText(String.valueOf(atletas.getMediaNum()));
        roomPontosNum.setText(String.valueOf(atletas.getPontosNum()));
        roomPosicaoId.setText(String.valueOf(atletas.getPosicaoId()));
        roomPrecoNum.setText(String.valueOf(atletas.getPrecoNum()));
        roomVariacaoNum.setText(String.valueOf(atletas.getVariacaoNum()));
